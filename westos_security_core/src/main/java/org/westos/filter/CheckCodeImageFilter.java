...
@Component("checkCodeImageFilter")
public class CheckCodeImageFilter extends OncePerRequestFilter {
    @Autowired
    ...
    protected void doFilterInternal(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, FilterChain filterChain) throws ServletException, IOException {
        //判断用户的登录请求
        if (httpServletRequest.getMethod().equalsIgnoreCase("post") && httpServletRequest.getRequestURI().equals("/login/form")) {
            try {
    ...
    private void validateCode(HttpServletRequest httpServletRequest) {
        ...
        //获取后台生成的验证码
        String checkCode = (String) httpServletRequest.getSession().getAttribute("checkCode");
